...
function criptografar() {
    ...
    document.getElementById("mensagem" && "cripto").innerHTML = "";

    // Recebe a string
    let txtOriginal = document.getElementById("txt").value;
    ...
    document.getElementById("mensagem").innerHTML = "<div class='innerContent' id='conteudo'>" + txtLower + "</div>";
    document.getElementById("branco").innerHTML = but_copy;
